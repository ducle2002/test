...
namespace IMAX.Services.SmartSocial.Providers.Dto
{
    [Table("Providers")]
    ...
    public class GetProvidersByAdminInputDto : CommonInputDto
    {
        public int? TenantId { get; set; }
        public FORM_ID_ADMIN_GET_PROVIDER FormId { get; set; }
