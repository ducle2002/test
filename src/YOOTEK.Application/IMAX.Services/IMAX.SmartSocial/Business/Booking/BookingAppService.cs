...
using IMAX.Services.SmartSocial.Bookings.Dto;
...
using PProvider = IMAX.Application.Protos.Business.Providers.PProvider;
using PRecipientAddress = IMAX.Application.Protos.Business.Bookings.PRecipientAddress;

namespace IMAX.Services.SmartSocial.Bookings
{
    ...
    public class BookingAppService : IMAXAppServiceBase, IBookingAppService
    {
