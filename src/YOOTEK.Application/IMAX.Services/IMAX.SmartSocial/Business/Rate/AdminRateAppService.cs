...
using IMAX.Services.SmartSocial.Rates.Dto;
using System;
using System.Threading.Tasks;

namespace IMAX.Services.SmartSocial.Rates
{
    ...
    [AbpAuthorize]
    public class AdminRateAppService : IMAXAppServiceBase, IAdminRateAppService
    {
