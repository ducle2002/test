...
using IMAX.IMAX.Services.IMAX.DichVu.CheckingObjectServ.CheckObjectDto;
using System;
...
namespace IMAX.IMAX.Services.IMAX.DichVu.CheckingObjectServ
{
    ...
    public class CheckingObjService : IMAXAppServiceBase, ICheckObjService
    {
