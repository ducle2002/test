...
namespace IMAX.Services
{
    ...
    public class UserQuestionAnswerAppService : IMAXAppServiceBase, IUserQuestionAnswerAppService
    {
        ...
        public async Task<object> GetAnswersByQuestionAsync(GetAllCommentForumSocialInput input)
        {
            try
            {
