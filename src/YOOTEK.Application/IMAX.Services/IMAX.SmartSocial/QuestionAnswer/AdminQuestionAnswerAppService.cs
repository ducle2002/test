...
namespace IMAX.Services
{
    ...
    public class AdminQuestionAnswerAppService : IMAXAppServiceBase, IAdminQuestionAnswerAppService
    {
        ...
        public async Task<object> GetAllCommentByQuestionAnswerAsync(GetAllCommentForumSocialInput input)
        {
            try
            {
