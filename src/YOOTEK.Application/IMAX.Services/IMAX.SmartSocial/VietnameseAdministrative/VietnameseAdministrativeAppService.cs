...
namespace IMAX.IMAX.Services.IMAX.SmartSocial.VietnameseAdministrative
{
    ...
    public class VietnameseAdministrativeAppService : IMAXAppServiceBase, IVietnameseAdministrativeAppService
    {
