...
{
    public interface IAdminForumExcelExporter
    {
        FileDto ExportToFile(List<ExportForumDto> input);
    }

    public class AdminForumExporter : NpoiExcelExporterBase, IAdminForumExcelExporter
    {
        public AdminForumExporter(ITempFileCacheManager tempFileCacheManager) : base(tempFileCacheManager) { }
        public FileDto ExportToFile(List<ExportForumDto> input)
        {
        ...
        protected string GetChatLog(List<CommentForumDto> input)
        {
            var data = "";
