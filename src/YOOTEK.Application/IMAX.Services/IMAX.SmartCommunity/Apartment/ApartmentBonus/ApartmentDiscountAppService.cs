...
using IMAX.EntityDb;
using IMAX.IMAX.Services.IMAX.SmartCommunity.ApartmentDiscount;
...
namespace IMAX.Services
{
    ...
    public class ApartmentDiscountAppService : IMAXAppServiceBase, IApartmentDiscountAppService
    {
