...
namespace IMAX.Services
{
    ...
    public class AdminApartmentAppService : IMAXAppServiceBase, IAdminApartmentAppService
    {
                    ...
                    try
                    {
                        ...
                        for (int row = 2; row <= rowCount; row++)
                        {
                            ...
                            listApartmentImports.Add(new Apartment()
                            {
                                ...
                                BuildingId = _organizationUnit.FirstOrDefault(x => x.ProjectCode == buildingCode)?.Id ?? 0,
