...
using IMAX.EntityDb;
using IMAX.IMAX.Services.IMAX.SmartSocial.BusinessNEW.BusinessDto;
using IMAX.IMAX.Services.IMAX.SmartSocial.BusinessNEW.BusinessDto.GridViewBusiness;
...
namespace IMAX.Services
{
    ...
    public class TenantBusinessGridViewAppService : IMAXAppServiceBase, ITenantBusinessGridViewAppService
    {
