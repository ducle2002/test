...
using IMAX.EntityDb;
using IMAX.IMAX.Services.IMAX.SmartCommunity.DocumentTypes.dto;
...
namespace IMAX.Services
{
    ...
    public class AdminDocumentTypesAppService : IMAXAppServiceBase, IAdminDocumentTypesAppService
    {
