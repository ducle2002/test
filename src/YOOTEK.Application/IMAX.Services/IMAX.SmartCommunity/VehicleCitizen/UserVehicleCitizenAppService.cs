...
namespace IMAX.IMAX.Services.IMAX.SmartCommunity.VehicleCitizen
{
    public interface IUserVehicleCitizenAppService: IApplicationService { }
    public class UserVehicleCitizenAppService: IMAXAppServiceBase, IUserVehicleCitizenAppService
    {
