...
using Abp.UI;
using IMAX.Authorization.BillInvoices;
...
using IMAX.Services.SmartCommunity.BillingInvoice.Dto;
...
namespace IMAX.Services.SmartCommunity.BillingInvoice
{
    ...
    public class BillInvoiceAppService : IMAXAppServiceBase, IBillInvoiceAppService
    {
