...
using IMAX.IMAX.Services.IMAX.SmartCommunity.MaterialManagement.Material.ExcelExporter;
...
namespace IMAX.Services
{
    ...
    [AbpAuthorize]
    public class MaterialImportExportManagementAppService : IMAXAppServiceBase, IMaterialImportExportManagementAppService
    {
