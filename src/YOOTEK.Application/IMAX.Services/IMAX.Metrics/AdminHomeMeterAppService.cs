...
using IMAX.IMAX.Services.IMAX.Metrics.Dto;
...
namespace IMAX.IMAX.Services.IMAX.Metrics
{
    ...
    public class AdminHomeMeterAppService : IMAXAppServiceBase, IAdminHomeMeterAppService
    {
