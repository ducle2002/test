...
{
    public interface IAdminQuestionAnswerExcelExporter
    {
        FileDto ExportToFile(List<ExportQuestionAnswerDto> input);
    }
    public class AdminQuestionAnswerExcelExporter : NpoiExcelExporterBase, IAdminQuestionAnswerExcelExporter
    {
        public AdminQuestionAnswerExcelExporter(ITempFileCacheManager tempFileCacheManager) : base(tempFileCacheManager) { }
        public FileDto ExportToFile(List<ExportQuestionAnswerDto> input)
        {
        ...
        protected string GetChatLog(List<CommentQuestionAnswerDto> input)
        {
            var data = "";
