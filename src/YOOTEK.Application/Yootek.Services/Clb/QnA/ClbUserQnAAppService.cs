...
//namespace Yootek.Yootek.Services.Yootek.SmartSocial.QuestionAnswer
//{
//    public interface IClbUserQuestionAnswerAppService : IApplicationService { }
//    public class ClbUserQuestionAnswerAppService : YootekAppServiceBase, IClbUserQuestionAnswerAppService
//    {
...
//        public ClbUserQuestionAnswerAppService(IRepository<ClbForum, long> forumRepos, IRepository<ClbForumComment, long> forumCommentRepos, IRepository<User, long> userRepos)
//        {
...
//        protected IQueryable<ClbQuestionAnswerDto> QueryDataQNA(GetAllClbQnASocialInput input)
//        {
...
//        public async Task<object> GetAllQuestionAnswerSocialAsync(GetAllClbQnASocialInput input)
//        {
//            try
//            {
...
//        public async Task<object> GetAnswersByQuestionAsync(GetAllClbCommentForumSocialInput input)
//        {
//            try
//            {
...
//        [Obsolete]
//        public async Task<object> CreateOrUpdateQuestionAnswer(ClbForumInputDto input)
//        {
//            try
//            {
//                long t1 = TimeUtils.GetNanoseconds();
...
//                {
//                    //Insert
//                    var insertInput = input.MapTo<ClbForum>();
...
//        [Obsolete]
//        public async Task<object> CreateOrUpdateCommentQNA(ClbCommentForumInputDto input)
//        {
//            try
//            {
//                long t1 = TimeUtils.GetNanoseconds();
