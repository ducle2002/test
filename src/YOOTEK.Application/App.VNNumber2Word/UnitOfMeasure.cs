...
namespace NumToWords.VietNamese
{
    ...
    public sealed class UnitOfMeasure
    {
        ...
        /// </summary>
        public static readonly UnitOfMeasure Ruble = new UnitOfMeasure(Gender.Masculine, "đồng", "đồng", "đồng");
        
        /// <summary>
        /// Definition of kopek - cent equivalent for rubles.
        /// </summary>
        public static readonly UnitOfMeasure Kopek = new UnitOfMeasure(Gender.Feminine, "xu", "xu", "xu");
