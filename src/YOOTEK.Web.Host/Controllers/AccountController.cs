...
//            return Json(new AjaxResponse {ClickAction = returnUrl});
//        }
...
//            if (result.Succeeded)
//            {
//                return Json(new AjaxResponse {ClickAction = model.ReturnUrl});
//            }
...
//            return Json(new AjaxResponse
//            {
//                ClickAction = _webUrlService.GetSiteRootAddress(output.TenancyName) +
